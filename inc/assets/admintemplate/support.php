...
<ul class="dynasty-tab">
	...
	<li class="tab"><a class="active" href="admin.php?page=theme_support_option">Support <a></li>
...
<div class="dynasty-page">
	<form method="post" action="options.php">
		...
		<?php settings_fields('theme-support-register'); ?>
		<?php do_settings_sections('theme_support_option'); ?>
